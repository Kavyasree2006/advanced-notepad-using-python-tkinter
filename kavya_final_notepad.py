...
main_application.iconbitmap(r"C:\Users\kavya\OneDrive\Desktop\sap\Notepad_22522.ico")
...
bold_font.configure(weight="bold")
text_editor.tag_configure("bold", font=bold_font)
bold_image = PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\bold.png")
...
italic_font.configure(slant="italic")
text_editor.tag_configure("italic", font=italic_font)
italic_image = PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\italic.png")
...
underline_font.configure(underline=True)
text_editor.tag_configure("underline", font=underline_font)
underline_icon = PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\underline.png")
underline_btn = ttk.Button(tool_bar_label, image=underline_icon, command=underline_fun)
underline_btn.grid(row=0, column=4)

## font color button
font_color_icon = tk.PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\font-colo.png")
...
## align left
align_left_icon = tk.PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\align_left.png")
...
## align center
align_center_icon = tk.PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\Align_Center.png")
...
## align right
align_right_icon = tk.PhotoImage(file=r"C:\Users\kavya\OneDrive\Desktop\sap\icons\align_right.png")
